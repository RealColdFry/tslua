// Package compiler wraps tsgolint's compiler shim and adds Program_UpdateProgram.
package compiler
...
//go:linkname Program_IsSourceFileDefaultLibrary github.com/microsoft/typescript-go/internal/compiler.(*Program).IsSourceFileDefaultLibrary
func Program_IsSourceFileDefaultLibrary(recv *compiler.Program, path tspath.Path) bool

//go:linkname Program_IsSourceFileFromExternalLibrary github.com/microsoft/typescript-go/internal/compiler.(*Program).IsSourceFileFromExternalLibrary
func Program_IsSourceFileFromExternalLibrary(recv *compiler.Program, file *ast.SourceFile) bool
