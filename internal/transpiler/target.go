...
func (t LuaTarget) BitLibrary() string {
	...
	case LuaTargetLuaJIT:
		return "bit"
	case LuaTargetLua52, LuaTargetLuau:
		return "bit32"
	default:
		return ""
	}
...
func (t LuaTarget) UsesTableUnpack() bool {
	switch t {
	case LuaTargetLua52, LuaTargetLua53, LuaTargetLua54, LuaTargetLua55, LuaTargetLuau:
		return true
	default:
		return false
	}
...
func (t LuaTarget) SupportsFloorDiv() bool {
	switch t {
	case LuaTargetLua53, LuaTargetLua54, LuaTargetLua55, LuaTargetLuau:
		return true
	default:
		return false
	}
...
// HasNativeContinue returns whether the target supports the `continue` keyword natively.
// Luau is the only target with native continue.
...
func ValidTarget(s string) bool {
	switch LuaTarget(s) {
	case LuaTargetUniversal, LuaTargetLua50, LuaTargetLua51, LuaTargetLua52, LuaTargetLua53, LuaTargetLua54, LuaTargetLua55, LuaTargetLuaJIT, LuaTargetLuau:
		return true
	default:
		return false
	}
